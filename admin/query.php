  ...
  <script>
    function markAsRead(id) {
      if (confirm("Do you really want to mark this as Read?")) {
        window.location.href = "update_query.php?id=" + id; // Redirects to update_query.php
      }
    }
  </script>
              ...
              <tr>
                ...
                <td>
                  <?php if ($row['query_status'] == 1) { ?>
                    Read
                  <?php } else { ?>
                    <a href="#" onclick="markAsRead(<?php echo $row['query_id']; ?>)"><b>Pending</b></a>
                  <?php } ?>
                </td>
        ...
        <div class="table-responsive" style="text-align:center;">
          ...
          if (mysqli_num_rows($result1) > 0) {
            ...
            for ($i = 1; $i <= $total_page; $i++) {
              echo '<li class="' . ($i == $page ? "active" : "") . '"><a href="query.php?page=' . $i . '">' . $i . '</a></li>';
            }
            if ($total_page > $page) {

...
<?php
include 'conn.php';  // Using your existing database connection
include 'session.php';
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      if (isset($_POST['update'])) {
          ...
          // Update query using existing database connection from conn.php
          ...
          if ($result) {
              ...
              echo '<div class="alert alert-danger"><b>Error Updating Contact Details: ' . mysqli_error($conn) . '</b></div>';
          }
      }
      ?>
